...
Content:
This piece visualizes the emotional arc of my family communication over the course of the quarter. Each week is represented through abstracted visual forms—either drawn as flowers or shaped via soft, organic plots—to communicate the rhythm and length of our conversations.
...
Form:
My visualization takes the form of a watercolor painting (or: a stylized violin-jitter plot in R with pastel colors and symbolic shapes). It emphasizes aesthetics and emotional tone over analytical precision.
